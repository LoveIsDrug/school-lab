                    ...
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{URL::to('/payment')}}"><i class="fa facrosshairs"></i> Thanh toán</a></li>
                                ...
                                ?>
                            <li><a href="{{URL::to('/login-checkout')}}"><i class="fafa-crosshairs"></i> Thanh toán</a>
                            </li>
                                <?php
                            }
                            ?><?php
                            ...
                            <li><a href="{{URL::to('/logout-checkout')}}"><i class="fa fa-lock"></i> Đăng
                                    xuất </a></li>
                            <li><a href="{{URL::to('/taikhoan')}}"><i class="fa falock"></i>Thông tin
                                    của {{ Session::get('customer_name') }} </a></li>
